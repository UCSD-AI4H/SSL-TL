...
parser.add_argument('--root-dir', type=str, default='./tl-ssl/data/102Flower',
...
parser.add_argument('--save-path',default='ssl_resnet50target_flower',type=str)
...
parser.add_argument('--ratio', type=float, default=11)
# options for moco v2
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = Flower102(root_dir=args.root_dir, mode='train',
                         transforms = moco.loader.TwoCropsTransform(transforms.Compose(augmentation)))
    val_datset = Flower102(root_dir=args.root_dir, mode='val', transforms=test_trans)

    test_dataset = Flower102(root_dir=args.root_dir, mode='test', transforms=test_trans)

    # train_dataset = INAT(root = args.root_dir,ratio=args.ratio,
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    # for i, (images, im_id, target, tax_ids) in enumerate(train_loader):
