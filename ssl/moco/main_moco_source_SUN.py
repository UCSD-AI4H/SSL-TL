...
parser.add_argument('--resume', default='./SUN9w/checkpoint_0125.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--save-path',default='SUN9w',type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = SUNDataset(root=args.root_dir,
                               number_per_class=410,
