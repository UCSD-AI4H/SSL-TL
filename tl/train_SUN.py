...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoint/SUN/',
    ...
    parser.add_argument('--root-dir', type=str, default='./data/SUN/SUN397',
                        help='path to the image folder')
    parser.add_argument('--train-json', type=str, default='./data/inat/train2018.json',
    ...
    parser.add_argument('--num-class', type = int, default=397, help='Number of class for the classification')
    ...
    valset = datasets.ImageFolder('path/SUN397', test_trans)
