...
parser.add_argument('--save-path',default='caltech',type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = ImageDataset(images=Caltech.train_images, labels=Caltech.train_label, transforms=moco.loader.TwoCropsTransform(transforms.Compose(augmentation)))
