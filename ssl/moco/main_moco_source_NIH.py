...
parser.add_argument('--ann_file', default='./dataset/NIH/NIH_train_9k.csv', type=str,
...
parser.add_argument('--save-path', default='NIH9k1', type=str)
# moco specific configs:
parser.add_argument('--moco-dim', default=128, type=int,
                    help='feature dimension (default: 128)')
parser.add_argument('--moco-k', default=3200, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = NIHDataset(root=args.root_dir, ann_file=args.ann_file,
