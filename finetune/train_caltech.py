...
from utils import Caltech256,ImageDataset
...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoint/s_unbalance1_t_caltech_resnet50_moco/',
    ...
    parser.add_argument('--transfer-resume', type=str, default='../ssl/moco/imagenet_resnet_unbalance1/checkpoint_0135.pth.tar',
                        help='Path to load transfering pretrained model')
    parser.add_argument('--resume', type = str, default='./checkpoint/s_inat_t_caltech_resnet50_tl/best.pth.tar',
...
def evaluate():
    ...
    Caltech = Caltech256(root=args.root_dir, train_file=args.train_file, val_file=args.val_file,
