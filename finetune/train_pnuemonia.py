...
def main():
    ...
    parser.add_argument('--checkpoint-path',type= str, default='./checkpoint/s_unbalance1_t_Xray_resnet50_tl/',
    ...
    parser.add_argument('--epoch',type = int ,default=30, help='Maximum training epoch')
    parser.add_argument('--start-epoch',type = int ,default=0, help='Start training epoch')

    parser.add_argument('--train-dir',type=str,default='../data/Pneumonia/chest_xray/train')
    parser.add_argument('--val-dir',type=str,default='../data/Pneumonia/chest_xray/val')
    parser.add_argument('--test-dir',type=str,default='../data/Pneumonia/chest_xray/test')
    ...
    parser.add_argument('--transfer-resume', type=str,
                        default='./checkpoint/imagnet_resnet50_tl_unbalance1/best.pth.tar',
    ...
    print('dataset created\ttotal {}\ttrain {}\tval {}\ttest {}'.format(len(trainset) + len(valset) + len(testset), len(trainset), len(valset), len(testset)))
    ...
    sheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=5)
