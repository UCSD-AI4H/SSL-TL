...
parser.add_argument('--caltech-dir', type=str, default='./data/Caltech256',
...
parser.add_argument('--resume', default='./SUN+caltech/checkpoint_0105.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--save-path',default='SUN+caltech',type=str)
