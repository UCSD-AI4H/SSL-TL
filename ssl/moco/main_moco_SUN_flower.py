...
parser.add_argument('--flower-dir', type=str, default='./data/Flower102',
...
parser.add_argument('--save-path',default='SUN+flower',type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = CombineDataset(images1 = flower.images,images2 = SUNdataset.images,
